...
const Intro = () => {
  ...
  return (
      <div className="bg-black w-screen min-h-screen">
        ...
        <section
            className="bg-gradient-to-b from-black to-indigo-950 bg-black text-white h-screen flex flex-col justify-center items-center">
        ...
        <section className="bg-slate-100">
          <Cover className="bg-slate-100 md:p-20 p-10">
            ...
            <p className="text-2xl mb-4">
              열정적인 동아리 부원들과 함께 프로그래밍을 통해 앱이나 웹사이트를 만들어 실제로 사용할 수 있는 멋진 결과물들을 만들어 내고 있습니다.
            </p>
            <p className="text-2xl mb-4">
